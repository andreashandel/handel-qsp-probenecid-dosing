...
schedule_files <- c(
  s1 = 'model1-timeseries-baseline.png',
  s2 = 'model1-timeseries-d2tx.png',
  s3 = 'model1-timeseries-d3tx.png',
  s4 = 'model1-timeseries-dailytx.png',
  s5 = 'model1-timeseries-singletx.png'
)
...
for (i in 1:nsamp) {
  ...
  figname = paste0('model1-bestfit', i, '.png')
  png(
