...
pars_file = here::here('data/processed-data/model2-fixed-parameters.csv')
...
if (nsamp == 0) {
  bestfitfile = 'model2-bestfit-single.Rds'
} else {
  bestfitfile = 'model2-bestfit-sample.Rds'
}
...
########################################
b = 1e-7 # infection rate
bl = 1e-12
bh = 1e-5
k = 1e-4 #adaptive response virus removal
kl = 1e-10
kh = 1
p = 1e3 #virus production rate
pl = 1
ph = 1e7
...
gF = 5 #max innate growth
gFl = 1e-3
gFh = 1e3
hV = 4 # saturation for virus induction effect
hVl = 1e-2
hVh = 1e2
Fmax = 1 # max innate response
Fmaxl = 0.1
Fmaxh = 1e3
hF = 1 # T-cell induction response
hFl = 1e-5
hFh = 1e3
gS = 15 #induction of symptoms by innate
gSl = 1e-3
gSh = 1e3
...
Emax_Fl = 1e-3
Emax_Fh = 1
C50_F = 1e-2 #50% reduction on innnate
C50_Fl = 1e-10
C50_Fh = 1e2
C50_V = 1e-7 
C50_Vl = 1e-10
...
maxsteps = 200 #number of steps/iterations for algorithm
